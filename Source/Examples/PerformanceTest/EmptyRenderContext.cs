...
namespace PerformanceTest
{
    ...
    public class EmptyRenderContext : IRenderContext
    {
        ...
        /// <inheritdoc/>
        public void DrawRectangle(OxyRect rectangle, OxyColor fill, OxyColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode, double[] dashArray)
        {
        }

        /// <inheritdoc/>
        public void DrawRectangles(IList<OxyRect> rectangles, OxyColor fill, OxyColor stroke, double thickness, EdgeRenderingMode edgeRenderingMode, double[] dashArray)
        {
        }
