...
namespace OxyPlot.Series
{
    ...
    public struct BoxPlotItem
    {
        ...
        public BoxPlotItem(IList<double> dataPoints,
                           BoxPlotWhiskerType whiskerType)
        {
            ...
            switch (whiskerType)
            {
                case BoxPlotWhiskerType.IQR:
                    double IQR = Q3 - Q1;
                    UpperWhisker = (Q3 + 1.5 * IQR);
                    LowerWhisker = (Q1 - 1.5 * IQR);
                    break;
                case BoxPlotWhiskerType.MinMax:
                    ...
                    LowerWhisker = min;
                    break;
                case BoxPlotWhiskerType.NinthPercentile:
                    ...
                    break;
                case BoxPlotWhiskerType.SecondPercentile:
