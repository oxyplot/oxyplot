// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContinuousHistogramSeries.cs" company="OxyPlot">
//   Copyright (c) 2014 OxyPlot contributors
// </copyright>
// <summary>
//   Represents a series that can be bound to a collection of ContinuousHistogramItems representing bins from a Histogram.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace OxyPlot.Series
{
    ...
    public class ContinuousHistogramSeries : XYAxisSeries
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinuousHistogramSeries" /> class.
        /// </summary>
        ...
        public override TrackerHitResult GetNearestPoint(ScreenPoint point, bool interpolate)
        {
            ...
            // if no ContinuousHistogramItems contain the point, return null
            return null;
        }
