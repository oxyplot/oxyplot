// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContinuousHistogramItem.cs" company="OxyPlot">
//   Copyright (c) 2014 OxyPlot contributors
// </copyright>
// <summary>
//   Represents an item in a ContinuousHistogramSeries.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace OxyPlot.Series
{
    ...
    /// </summary>
    public class ContinuousHistogramItem : ICodeGenerating
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContinuousHistogramItem" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified point lies within the boundary of the ContinuousHistogramItem.
        /// </summary>
        /// <param name="p">The DataPoint to determine whether or not lies within the boundary of the ContinuousHistogramItem.</param>
