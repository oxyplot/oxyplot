    ...
    public class PieSeries : ISeries
    {
        ...
        public void UpdateData()
        {
            ...
            foreach (object o in ItemsSource)
            {
                ...
                if (pil != null) slice.Label = Convert.ToString(pil.GetValue(o, null));
                if (pic != null) slice.Fill = (OxyColor)pic.GetValue(o, null);
                slices.Add(slice);
            }
        }
        ...
        public void Render(IRenderContext rc, PlotModel model)
        {
            ...
            // todo: reduce available size due to labels
            ...
            foreach (var slice in slices)
            {
                ...
                var mp = new ScreenPoint(model.MidPoint.X + explodedRadius * Math.Cos(midAngleRadians), model.MidPoint.Y + explodedRadius * Math.Sin(midAngleRadians));
                ...
                if (OutsideLabelFormat != null)
                {
                    ...
                    var tp1 = new ScreenPoint(tp0.X + TickRadialLength * Math.Cos(midAngleRadians), tp0.Y + TickRadialLength * Math.Sin(midAngleRadians));
                    ...
                    rc.DrawText(labelPosition, label, model.TextColor, model.LegendFont, model.LegendFontSize, 500, 0, sign > 0 ? HorizontalTextAlign.Left : HorizontalTextAlign.Right, VerticalTextAlign.Middle);
                }
                ...
                if (InsideLabelFormat != null)
                {
                    ...
                    rc.DrawText(labelPosition, label, model.TextColor, model.LegendFont, model.LegendFontSize, 500, textAngle, HorizontalTextAlign.Center, VerticalTextAlign.Middle);
                }
