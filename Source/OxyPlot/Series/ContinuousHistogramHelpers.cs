// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ContinuousHistogramHelpers.cs" company="OxyPlot">
//   Copyright (c) 2014 OxyPlot contributors
// </copyright>
// <summary>
//   Provides methods to collect data samples into bins for use with a <see cref="ContinuousHistogramSeries" />.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace OxyPlot.Series
{
    ...
    /// Provides methods to collect data samples into bins for use with a <see cref="ContinuousHistogramSeries" />.
    /// </summary>
    public static class ContinuousHistogramHelpers
    {
        /// <summary>
        /// Collects samples into <paramref name="binCount"/> bins (<see cref="ContinuousHistogramItem" />), uniformly distributed between <paramref name="start"/> and <paramref name="end"/>.
        /// </summary>
        ...
        /// <returns>An enumeration of <see cref="ContinuousHistogramItem" /> corresponding to uniformly generated bins with heights computed from the proportion of samples placed within.</returns>
        ...
        /// <summary>
        /// Collects samples into tightly packed bins (<see cref="ContinuousHistogramItem" />) defined by <paramref name="binBreaks"/>.
        /// </summary>
        /// <param name="samples">The samples to collect into bins.</param>
        /// <param name="binBreaks">The start and end values for the bins.</param>
        /// <param name="countUnplaced">A value indicating whether items not placed in bins should be considered when computing frequencies.</param>
        /// <returns>An enumerations of <see cref="ContinuousHistogramItem" /> corresponding to the generated bins with heights computed from the proportion of samples placed within.</returns>
