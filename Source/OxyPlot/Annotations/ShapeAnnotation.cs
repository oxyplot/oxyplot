...
{
    /// <summary>
    /// Provides an abstract base class for shape annotations, such as <see cref="PointAnnotation"/>, <see cref="EllipseAnnotation"/>,
    /// <see cref="PolygonAnnotation"/> and <see cref="RectangleAnnotation"/>.
    /// </summary>
