...
namespace OxyPlot.Wpf
{
    public class RangeAxis : Axis
    {
        ...
        public RangeAxis()
        {
            ModelAxis = new OxyPlot.RangeAxis();
        }

        public override void UpdateModelProperties()
        {
            var a = ModelAxis as OxyPlot.RangeAxis;
            a.Minimum = Minimum;
            a.Maximum = Maximum;
            a.Title = Title;
            a.Position = Position;
            ...
            //ExtraGridlineStyle = ExtraGridlineStyle;
            //ExtraGridlineColor = ExtraGridlineColor;
            //ExtraGridlineThickness = ExtraGridlineThickness;
